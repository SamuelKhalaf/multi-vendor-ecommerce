                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> شريط التمرير الجانبى
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> صور  شريط التمرير </h4>
                                ...
                                <figure class="col-lg-3 col-md-6 col-12" itemprop="associatedMedia" itemscope
                                    ...
                                    <a href="{{ $image->photo }}" itemprop="contentUrl" data-size="480x360">
                                        <img class="img-thumbnail img-fluid" src="{{ $image->photo }}"
                                             itemprop="thumbnail" alt="Uploaded Image">
                                    </a>
                                </figure>
                            @endforeach
                        @else
                            <p class="text-center">لا يوجد صور حتى الآن</p>
                        @endif
                    </div>
                </div>
            </div>
